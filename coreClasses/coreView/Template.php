  ...
  */
  ...
  public function exec( $toString = false ) {
    ...
    if( $this->tpl ) {
      ...
      $mainClientIncludes .= '<script defer src="'.$this->cgmMediaserverHost.'vendor/bower/bootstrap/dist/js/bootstrap.min.js"></script>' . "\n";
    ...
    //  $mainClientIncludes .= $this->getClientStylesHtml();
      ...
      if( !$this->cgmMediaserverCompileLess){
        $clientIncludes .= ').then(function () { cogumelo.log(\'JS files already loaded\'); });'."\n\n";
      }
      else {
